...
f1 <- data.frame(Case = case, PPV = fy1.1)
f2 <- data.frame(Case = case, PPV = fy2.1)
f3 <- data.frame(Case = case, PPV = fy3.1)
f4 <- data.frame(Case = case, PPV = fy4.1)
f5 <- data.frame(Case = case, PPV = fy5.1)
f6 <- data.frame(Case = case, PPV = fy6.1)
f7 <- data.frame(Case = case, PPV = fy7.1)
f8 <- data.frame(Case = case, PPV = fy8.1)
f9 <- data.frame(Case = case, PPV = fy9.1)
f10 <- data.frame(Case = case, PPV = fy10.1)
f11 <- data.frame(Case = case, PPV = fy11.1)
f12 <- data.frame(Case = case, PPV = fy12.1)
...
bp2 <- ggplot(f2, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(54/100/90)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp3 <- ggplot(f3, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(54/1000/100)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp4 <- ggplot(f4, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(54/1000/90)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp5 <- ggplot(f5, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(51/100/100)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp6 <- ggplot(f6, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(51/100/90)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp7 <- ggplot(f7, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(51/1000/100)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp9 <- ggplot(f9, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(48/100/100)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp10 <- ggplot(f10, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(48/100/90)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp11 <- ggplot(f11, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(48/1000/100)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
bp12 <- ggplot(f12, aes(Case, PPV)) +
    geom_boxplot(aes(x=factor(Case), y=PPV), fill="yellow", alpha=0.6) +
    theme_economist() +
    ggtitle("Boxplot_PPV_LUAD (Deseq2)") +
    labs(x="Case {TS(48/1000/90)}", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
    scale_x_discrete(breaks = c(3, 4, 5, 6, 7, 8, 10, 17, 23, 28, 45),
                     labels = c("n=3", "n=4", "n=5", "n=6", "n=7", "n=8",
                                "n=10", "n=17", "n=23", "n=28", "n=45")) +
...
ggsave(g1, file="bp1.54.ppv.de.luad.png", width=24, height=12)
ggsave(g2, file="bp1.51.ppv.de.luad.png", width=24, height=12)
ggsave(g3, file="bp1.48.ppv.de.luad.png", width=24, height=12)
ggsave(g4, file="bp2.100.ppv.de.luad.png", width=24, height=18)
ggsave(g5, file="bp2.90.ppv.de.luad.png", width=24, height=18)
ggsave(g6, file="bp3.100.ppv.de.luad.png", width=24, height=18)
ggsave(g7, file="bp3.1000.ppv.de.luad.png", width=24, height=18)
...
ppv1 <- ggplot(f1, aes(Case, PPV)) +
    theme_economist() +
    ggtitle("PPV(Mean)_LUAD (Deseq2)") +
    labs(x="Case", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
...
ppv1 + theme(plot.title=element_text(size=18, face="bold", 
                                     margin=margin(10, 0, 10, 0)),
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv1.54.de_luad.png", width=15, height=10)

ppv2 <- ggplot(f5, aes(Case, PPV)) +
    theme_economist() +
    ggtitle("PPV(Mean)_LUAD (Deseq2)") +
    labs(x="Case", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
...
ppv2 + theme(plot.title=element_text(size=18, face="bold", 
                                     margin=margin(10, 0, 10, 0)),
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv1.51.de_luad.png", width=15, height=10)

ppv3 <- ggplot(f9, aes(Case, PPV)) +
    theme_economist() +
    ggtitle("PPV(Mean)_LUAD (Deseq2)") +
    labs(x="Case", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
...
ppv3 + theme(plot.title=element_text(size=18, face="bold", 
                                     margin=margin(10, 0, 10, 0)),
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv1.48.de_luad.png", width=15, height=10)

ppv4 <- ggplot(f1, aes(Case, PPV)) +
    theme_economist() +
    ggtitle("PPV(Mean)_LUAD (Deseq2)") +
    labs(x="Case", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
...
ppv4 + theme(plot.title=element_text(size=18, face="bold", 
                                     margin=margin(10, 0, 10, 0)),
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv2.100.de_luad.png", width=15, height=10)

ppv5 <- ggplot(f2, aes(Case, PPV)) +
    theme_economist() +
    ggtitle("PPV(Mean)_LUAD (Deseq2)") +
    labs(x="Case", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
...
ppv5 + theme(plot.title=element_text(size=18, face="bold", 
                                     margin=margin(10, 0, 10, 0)),
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv2.90.de_luad.png", width=15, height=10)

ppv6 <- ggplot(f1, aes(Case, PPV)) +
    theme_economist() +
    ggtitle("PPV(Mean)_LUAD (Deseq2)") +
    labs(x="Case", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
...
ppv6 + theme(plot.title=element_text(size=18, face="bold", 
                                     margin=margin(10, 0, 10, 0)),
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv3.100.de_luad.png", width=15, height=10)

ppv7 <- ggplot(f3, aes(Case, PPV)) +
    theme_economist() +
    ggtitle("PPV(Mean)_LUAD (Deseq2)") +
    labs(x="Case", y="PPV") +
    scale_y_continuous(breaks = seq(0.5, 1, 0.05), limits = c(0.5, 1)) +
...
ppv7 + theme(plot.title=element_text(size=18, face="bold", 
                                     margin=margin(10, 0, 10, 0)),
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv3.1000.de_luad.png", width=15, height=10)
