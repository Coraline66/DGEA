...
ggsave(g1, file="bp1.54.tpr.ed_luad.png", width=24, height=12)
ggsave(g2, file="bp1.51.tpr.ed_luad.png", width=24, height=12)
ggsave(g3, file="bp1.48.tpr.ed_luad.png", width=24, height=12)
ggsave(g4, file="bp2.100.tpr.ed_luad.png", width=24, height=18)
ggsave(g5, file="bp2.90.tpr.ed_luad.png", width=24, height=18)
ggsave(g6, file="bp3.100.tpr.ed_luad.png", width=24, height=18)
ggsave(g7, file="bp3.1000.tpr.ed_luad.png", width=24, height=18)
...
ggsave("tpr1.54.ed_luad.png", width=15, height=10)
...
tpr2 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("tpr1.51.ed_luad.png", width=15, height=10)
...
tpr3 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("tpr1.48.ed_luad.png", width=15, height=10)
...
tpr4 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("tpr2.100.ed_luad.png", width=15, height=10)
...
tpr5 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("tpr2.90.ed_luad.png", width=15, height=10)
...
tpr6 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("tpr3.100.ed_luad.png", width=15, height=10)
...
tpr7 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("tpr3.1000.ed_luad.png", width=15, height=10)
