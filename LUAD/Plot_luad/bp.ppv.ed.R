...
ggsave(g1, file="bp1.54.ppv.ed.luad.png", width=24, height=12)
ggsave(g2, file="bp1.51.ppv.ed.luad.png", width=24, height=12)
ggsave(g3, file="bp1.48.ppv.ed.luad.png", width=24, height=12)
ggsave(g4, file="bp2.100.ppv.ed.luad.png", width=24, height=18)
ggsave(g5, file="bp2.90.ppv.ed.luad.png", width=24, height=18)
ggsave(g6, file="bp3.100.ppv.ed.luad.png", width=24, height=18)
ggsave(g7, file="bp3.1000.ppv.ed.luad.png", width=24, height=18)
...
ggsave("ppv1.54.ed_luad.png", width=15, height=10)
...
ppv2 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv1.51.ed_luad.png", width=15, height=10)
...
ppv3 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv1.48.ed_luad.png", width=15, height=10)
...
ppv4 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv2.100.ed_luad.png", width=15, height=10)
...
ppv5 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv2.90.ed_luad.png", width=15, height=10)
...
ppv6 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv3.100.ed_luad.png", width=15, height=10)
...
ppv7 + theme(plot.title=element_text(size=18, face="bold", 
             ...
             legend.position="right", legend.direction="vertical") +
    guides(colour = guide_legend(title.position = "top"))
ggsave("ppv3.1000.ed_luad.png", width=15, height=10)
