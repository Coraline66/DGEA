...
saveRDS(fil_des, file="fil_de3.RData")
saveRDS(fil_edg, file="fil_ed3.RData")
saveRDS(sen_de, file="sen_de3.RData")
saveRDS(sen_ed, file="sen_ed3.RData")
saveRDS(fdr_de, file="fdr_de3.RData")
saveRDS(fdr_ed, file="fdr_ed3.RData")