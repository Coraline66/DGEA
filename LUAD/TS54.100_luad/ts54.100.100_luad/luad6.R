...
saveRDS(fil_des, file="fil_de6.RData")
saveRDS(fil_edg, file="fil_ed6.RData")
saveRDS(sen_de, file="sen_de6.RData")
saveRDS(sen_ed, file="sen_ed6.RData")
saveRDS(fdr_de, file="fdr_de6.RData")
saveRDS(fdr_ed, file="fdr_ed6.RData")