...
saveRDS(fil_des, file="fil_de28.RData")
saveRDS(fil_edg, file="fil_ed28.RData")
saveRDS(sen_de, file="sen_de28.RData")
saveRDS(sen_ed, file="sen_ed28.RData")
saveRDS(fdr_de, file="fdr_de28.RData")
saveRDS(fdr_ed, file="fdr_ed28.RData")