...
saveRDS(fil_des, file="fil_de23.RData")
saveRDS(fil_edg, file="fil_ed23.RData")
saveRDS(sen_de, file="sen_de23.RData")
saveRDS(sen_ed, file="sen_ed23.RData")
saveRDS(fdr_de, file="fdr_de23.RData")
saveRDS(fdr_ed, file="fdr_ed23.RData")