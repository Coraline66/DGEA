...
saveRDS(fil_des, file="fil_de5.RData")
saveRDS(fil_edg, file="fil_ed5.RData")
saveRDS(sen_de, file="sen_de5.RData")
saveRDS(sen_ed, file="sen_ed5.RData")
saveRDS(fdr_de, file="fdr_de5.RData")
saveRDS(fdr_ed, file="fdr_ed5.RData")