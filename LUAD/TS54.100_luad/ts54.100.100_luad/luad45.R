...
saveRDS(fil_des, file="fil_de45.RData")
saveRDS(fil_edg, file="fil_ed45.RData")
saveRDS(sen_de, file="sen_de45.RData")
saveRDS(sen_ed, file="sen_ed45.RData")
saveRDS(fdr_de, file="fdr_de45.RData")
saveRDS(fdr_ed, file="fdr_ed45.RData")