...
saveRDS(fil_des, file="fil_de8.RData")
saveRDS(fil_edg, file="fil_ed8.RData")
saveRDS(sen_de, file="sen_de8.RData")
saveRDS(sen_ed, file="sen_ed8.RData")
saveRDS(fdr_de, file="fdr_de8.RData")
saveRDS(fdr_ed, file="fdr_ed8.RData")