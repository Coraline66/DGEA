...
saveRDS(fil_des, file="fil_de10.RData")
saveRDS(fil_edg, file="fil_ed10.RData")
saveRDS(sen_de, file="sen_de10.RData")
saveRDS(sen_ed, file="sen_ed10.RData")
saveRDS(fdr_de, file="fdr_de10.RData")
saveRDS(fdr_ed, file="fdr_ed10.RData")