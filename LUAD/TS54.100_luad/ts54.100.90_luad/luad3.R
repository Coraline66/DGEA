...
saveRDS(fil_des, file="fil90_de3.RData")
saveRDS(fil_edg, file="fil90_ed3.RData")
saveRDS(sen_de, file="sen90_de3.RData")
saveRDS(sen_ed, file="sen90_ed3.RData")
saveRDS(fdr_de, file="fdr90_de3.RData")
saveRDS(fdr_ed, file="fdr90_ed3.RData")