...
saveRDS(fil_des, file="fil90_de7.RData")
saveRDS(fil_edg, file="fil90_ed7.RData")
saveRDS(sen_de, file="sen90_de7.RData")
saveRDS(sen_ed, file="sen90_ed7.RData")
saveRDS(fdr_de, file="fdr90_de7.RData")
saveRDS(fdr_ed, file="fdr90_ed7.RData")