...
en_de <- readRDS("TSde_54_100_90.RData")
en_ed <- readRDS("TSed_54_100_90.RData")
...
saveRDS(fil_des, file="fil90_de45.RData")
saveRDS(fil_edg, file="fil90_ed45.RData")
saveRDS(sen_de, file="sen90_de45.RData")
saveRDS(sen_ed, file="sen90_ed45.RData")
saveRDS(fdr_de, file="fdr90_de45.RData")
saveRDS(fdr_ed, file="fdr90_ed45.RData")