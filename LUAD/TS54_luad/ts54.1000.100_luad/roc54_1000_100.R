...
fx1 <- as.numeric(readRDS("fdr_54.de.RData"))
fx2 <- as.numeric(readRDS("fdr_54.ed.RData"))
fy1 <- as.numeric(readRDS("sen_54.de.RData"))
fy2 <- as.numeric(readRDS("sen_54.ed.RData"))
...
roc.plot <- ggplot(ff, aes(fx1, fy1))  +
    ...
    theme_igray() +
    scale_color_manual(name="TS(54/1000/100)", breaks=leg, values=col) +
...
ggsave("roc.54_1000_100_luad.png", width=20, height=8)
...
ggsave("roc.54_1000_100.luad.png", width=10, height=10)
...
ggsave(g, file="bp54_1000_100_luad.png", width=24, height=12)
