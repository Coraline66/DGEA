...
saveRDS(fil_des, file="fil_de4.RData")
saveRDS(fil_edg, file="fil_ed4.RData")
saveRDS(sen_de, file="sen_de4.RData")
saveRDS(sen_ed, file="sen_ed4.RData")
saveRDS(fdr_de, file="fdr_de4.RData")
saveRDS(fdr_ed, file="fdr_ed4.RData")