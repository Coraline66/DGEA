...
en_de <- readRDS("TSde_54_100_100.RData")
en_ed <- readRDS("TSed_54_100_100.RData")
...
saveRDS(fil_des, file="fil_de17.RData")
saveRDS(fil_edg, file="fil_ed17.RData")
saveRDS(sen_de, file="sen_de17.RData")
saveRDS(sen_ed, file="sen_ed17.RData")
saveRDS(fdr_de, file="fdr_de17.RData")
saveRDS(fdr_ed, file="fdr_ed17.RData")