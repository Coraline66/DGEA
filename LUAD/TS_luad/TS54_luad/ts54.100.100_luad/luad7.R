...
saveRDS(fil_des, file="fil_de7.RData")
saveRDS(fil_edg, file="fil_ed7.RData")
saveRDS(sen_de, file="sen_de7.RData")
saveRDS(sen_ed, file="sen_ed7.RData")
saveRDS(fdr_de, file="fdr_de7.RData")
saveRDS(fdr_ed, file="fdr_ed7.RData")