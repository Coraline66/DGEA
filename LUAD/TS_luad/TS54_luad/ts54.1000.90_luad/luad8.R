...
source("edger.R")
source("rangen.R")
samp <- readRDS("samp8.RData")
en_de <- readRDS("TSde_54_1000_900.RData")
en_ed <- readRDS("TSed_54_1000_900.RData")
in_de <- readRDS("in_de8.RData")
in_ed <- readRDS("in_ed8.RData")
...
# Save Data
saveRDS(fil_des, file="fil54.de.8.RData")
saveRDS(fil_edg, file="fil54.ed.8.RData")
saveRDS(sen_de, file="sen54.de.8.RData")
saveRDS(sen_ed, file="sen54.ed.8.RData")
saveRDS(fdr_de, file="fdr54.de.8.RData")
saveRDS(fdr_ed, file="fdr54.ed.8.RData")