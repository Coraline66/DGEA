...
fx1 <- as.numeric(readRDS("fdr.54.de.RData"))
fx2 <- as.numeric(readRDS("fdr.54.ed.RData"))
fy1 <- as.numeric(readRDS("sen.54.de.RData"))
fy2 <- as.numeric(readRDS("sen.54.ed.RData"))
...
roc.plot <- ggplot(ff, aes(fx1, fy1))  +
    ...
    theme_igray() +
    scale_color_manual(name="TS(54/1000/90)", breaks=leg, values=col) +
...
ggsave("roc.54_1000_90_luad.png", width=20, height=8)
...
ggsave("roc.54_1000_90.luad.png", width=10, height=10)
...
ggsave(g, file="bp54_1000_90_luad.png", width=24, height=12)
