...
# Save Data
saveRDS(fil_des, file="fil54.de.45.RData")
saveRDS(fil_edg, file="fil54.ed.45.RData")
saveRDS(sen_de, file="sen54.de.45.RData")
saveRDS(sen_ed, file="sen54.ed.45.RData")
saveRDS(fdr_de, file="fdr54.de.45.RData")
saveRDS(fdr_ed, file="fdr54.ed.45.RData")