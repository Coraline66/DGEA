...
# Save Data
saveRDS(samp, file="samp_54.RData")
saveRDS(in_de, file="in_de.54.RData")
saveRDS(in_ed, file="in_ed.54.RData")
saveRDS(fil_des, file="fi.de54.RData")
saveRDS(fil_edg, file="fi.ed54.RData")
saveRDS(ts_des, file="TSde_54_1000_1000.RData")
saveRDS(ts_edg, file="TSed_54_1000_1000.RData")
saveRDS(Nde_900$int_tp, file="TSde_54_1000_900.RData")
saveRDS(Ned_900$int_tp, file="TSed_54_1000_900.RData")
