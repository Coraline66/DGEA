...
# Save Data
saveRDS(fil_des, file="fil54_de.45.RData")
saveRDS(fil_edg, file="fil54_ed.45.RData")
saveRDS(sen_de, file="sen54_de.45.RData")
saveRDS(sen_ed, file="sen54_ed.45.RData")
saveRDS(fdr_de, file="fdr54_de.45.RData")
saveRDS(fdr_ed, file="fdr54_ed.45.RData")