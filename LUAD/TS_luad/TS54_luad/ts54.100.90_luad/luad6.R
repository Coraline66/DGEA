...
saveRDS(fil_des, file="fil90_de6.RData")
saveRDS(fil_edg, file="fil90_ed6.RData")
saveRDS(sen_de, file="sen90_de6.RData")
saveRDS(sen_ed, file="sen90_ed6.RData")
saveRDS(fdr_de, file="fdr90_de6.RData")
saveRDS(fdr_ed, file="fdr90_ed6.RData")