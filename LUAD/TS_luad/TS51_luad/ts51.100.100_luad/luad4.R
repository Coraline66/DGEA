...
saveRDS(fil_des, file="fil51_de4.RData")
saveRDS(fil_edg, file="fil51_ed4.RData")
saveRDS(sen_de, file="sen51_de4.RData")
saveRDS(sen_ed, file="sen51_ed4.RData")
saveRDS(fdr_de, file="fdr51_de4.RData")
saveRDS(fdr_ed, file="fdr51_ed4.RData")