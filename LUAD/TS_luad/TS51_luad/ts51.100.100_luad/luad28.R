...
# Save Data
saveRDS(samp, file="samp28.RData")
saveRDS(in_de, file="in_de28.RData")
saveRDS(in_ed, file="in_ed28.RData")
saveRDS(fil_des, file="fil51_de28.RData")
saveRDS(fil_edg, file="fil51_ed28.RData")
saveRDS(sen_de, file="sen51_de28.RData")
saveRDS(sen_ed, file="sen51_ed28.RData")
saveRDS(fdr_de, file="fdr51_de28.RData")
saveRDS(fdr_ed, file="fdr51_ed28.RData")