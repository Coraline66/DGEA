...
saveRDS(fil_des, file="fil51_de17.RData")
saveRDS(fil_edg, file="fil51_ed17.RData")
saveRDS(sen_de, file="sen51_de17.RData")
saveRDS(sen_ed, file="sen51_ed17.RData")
saveRDS(fdr_de, file="fdr51_de17.RData")
saveRDS(fdr_ed, file="fdr51_ed17.RData")