...
en_de <- readRDS("TSde_51_100_100.RData")
en_ed <- readRDS("TSed_51_100_100.RData")
...
# Save Data
saveRDS(samp, file="samp10.RData")
saveRDS(in_de, file="in_de10.RData")
saveRDS(in_ed, file="in_ed10.RData")
saveRDS(fil_des, file="fil51_de10.RData")
saveRDS(fil_edg, file="fil51_ed10.RData")
saveRDS(sen_de, file="sen51_de10.RData")
saveRDS(sen_ed, file="sen51_ed10.RData")
saveRDS(fdr_de, file="fdr51_de10.RData")
saveRDS(fdr_ed, file="fdr51_ed10.RData")