...
# Save Data
saveRDS(samp, file="samp8.RData")
saveRDS(in_de, file="in_de8.RData")
saveRDS(in_ed, file="in_ed8.RData")
saveRDS(fil_des, file="fil51_de8.RData")
saveRDS(fil_edg, file="fil51_ed8.RData")
saveRDS(sen_de, file="sen51_de8.RData")
saveRDS(sen_ed, file="sen51_ed8.RData")
saveRDS(fdr_de, file="fdr51_de8.RData")
saveRDS(fdr_ed, file="fdr51_ed8.RData")