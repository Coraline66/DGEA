...
saveRDS(fil_des, file="fil51_de45.RData")
saveRDS(fil_edg, file="fil51_ed45.RData")
saveRDS(sen_de, file="sen51_de45.RData")
saveRDS(sen_ed, file="sen51_ed45.RData")
saveRDS(fdr_de, file="fdr51_de45.RData")
saveRDS(fdr_ed, file="fdr51_ed45.RData")