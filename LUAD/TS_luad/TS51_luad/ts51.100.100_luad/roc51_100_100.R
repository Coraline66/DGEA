...
fx1 <- as.numeric(readRDS("fdr51_de.RData"))
fx2 <- as.numeric(readRDS("fdr51_ed.RData"))
fy1 <- as.numeric(readRDS("sen51_de.RData"))
fy2 <- as.numeric(readRDS("sen51_ed.RData"))
...
roc.plot <- ggplot(ff, aes(fx1, fy1))  +
    ...
    theme_igray() +
    scale_color_manual(name="TS(51/100/100)", breaks=leg, values=col) +
...
ggsave("roc.51_100_100_luad.png", width=20, height=8)
...
ggsave("roc.51_100_100.luad.png", width=10, height=10)
...
ggsave(g, file="bp51_100_100_luad.png", width=24, height=12)
