...
# Save Data
saveRDS(fil_des, file="fil51_de.10.RData")
saveRDS(fil_edg, file="fil51_ed.10.RData")
saveRDS(sen_de, file="sen51_de.10.RData")
saveRDS(sen_ed, file="sen51_ed.10.RData")
saveRDS(fdr_de, file="fdr51_de.10.RData")
saveRDS(fdr_ed, file="fdr51_ed.10.RData")