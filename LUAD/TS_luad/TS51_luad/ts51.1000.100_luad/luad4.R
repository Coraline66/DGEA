...
# Save Data
saveRDS(fil_des, file="fil51_de.4.RData")
saveRDS(fil_edg, file="fil51_ed.4.RData")
saveRDS(sen_de, file="sen51_de.4.RData")
saveRDS(sen_ed, file="sen51_ed.4.RData")
saveRDS(fdr_de, file="fdr51_de.4.RData")
saveRDS(fdr_ed, file="fdr51_ed.4.RData")