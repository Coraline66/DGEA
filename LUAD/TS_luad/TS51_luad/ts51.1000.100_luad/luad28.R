...
source("edger.R")
source("rangen.R")
samp <- readRDS("samp28.RData")
en_de <- readRDS("TSde_51_1000_1000.RData")
en_ed <- readRDS("TSed_51_1000_1000.RData")
in_de <- readRDS("in_de28.RData")
in_ed <- readRDS("in_ed28.RData")
...
# Save Data
saveRDS(fil_des, file="fil51_de.28.RData")
saveRDS(fil_edg, file="fil51_ed.28.RData")
saveRDS(sen_de, file="sen51_de.28.RData")
saveRDS(sen_ed, file="sen51_ed.28.RData")
saveRDS(fdr_de, file="fdr51_de.28.RData")
saveRDS(fdr_ed, file="fdr51_ed.28.RData")