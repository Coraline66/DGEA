...
# Save Data
saveRDS(samp, file="samp_51.RData")
saveRDS(in_de, file="in_de.51.RData")
saveRDS(in_ed, file="in_ed.51.RData")
saveRDS(fil_des, file="fi.de51.RData")
saveRDS(fil_edg, file="fi.ed51.RData")
saveRDS(ts_des, file="TSde_51_1000_1000.RData")
saveRDS(ts_edg, file="TSed_51_1000_1000.RData")
saveRDS(Nde_900$int_tp, file="TSde_51_1000_900.RData")
saveRDS(Ned_900$int_tp, file="TSed_51_1000_900.RData")
