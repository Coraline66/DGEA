...
# Save Data
saveRDS(fil_des, file="fil51.de.8.RData")
saveRDS(fil_edg, file="fil51.ed.8.RData")
saveRDS(sen_de, file="sen51.de.8.RData")
saveRDS(sen_ed, file="sen51.ed.8.RData")
saveRDS(fdr_de, file="fdr51.de.8.RData")
saveRDS(fdr_ed, file="fdr51.ed.8.RData")