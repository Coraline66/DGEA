...
# Save Data
saveRDS(fil_des, file="fil51.de23.RData")
saveRDS(fil_edg, file="fil51.ed23.RData")
saveRDS(sen_de, file="sen51.de23.RData")
saveRDS(sen_ed, file="sen51.ed23.RData")
saveRDS(fdr_de, file="fdr51.de23.RData")
saveRDS(fdr_ed, file="fdr51.ed23.RData")