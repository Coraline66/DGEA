...
# Save Data
saveRDS(samp, file="samp51.RData")
saveRDS(in_de, file="in_de51.RData")
saveRDS(in_ed, file="in_ed51.RData")
saveRDS(fil_des, file="fi_de51.RData")
saveRDS(fil_edg, file="fi_ed51.RData")
saveRDS(ts_des, file="TSde_51_100_100.RData")
saveRDS(ts_edg, file="TSed_51_100_100.RData")
saveRDS(Nde_90$int_tp, file="TSde_51_100_90.RData")
saveRDS(Ned_90$int_tp, file="TSed_51_100_90.RData")
