...
# Save Data
saveRDS(fil_des, file="fil51.de5.RData")
saveRDS(fil_edg, file="fil51.ed5.RData")
saveRDS(sen_de, file="sen51.de5.RData")
saveRDS(sen_ed, file="sen51.ed5.RData")
saveRDS(fdr_de, file="fdr51.de5.RData")
saveRDS(fdr_ed, file="fdr51.ed5.RData")