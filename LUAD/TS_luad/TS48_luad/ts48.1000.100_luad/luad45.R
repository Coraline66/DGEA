...
source("edger.R")
source("rangen.R")
samp <- readRDS("samp45.RData")
en_de <- readRDS("TSde_48_1000_1000.RData")
en_ed <- readRDS("TSed_48_1000_1000.RData")
in_de <- readRDS("in_de45.RData")
in_ed <- readRDS("in_ed45.RData")
...
# Save Data
saveRDS(fil_des, file="fil48_de.45.RData")
saveRDS(fil_edg, file="fil48_ed.45.RData")
saveRDS(sen_de, file="sen48_de.45.RData")
saveRDS(sen_ed, file="sen48_ed.45.RData")
saveRDS(fdr_de, file="fdr48_de.45.RData")
saveRDS(fdr_ed, file="fdr48_ed.45.RData")