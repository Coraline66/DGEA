...
# Save Data
saveRDS(fil_des, file="fil48_de.6.RData")
saveRDS(fil_edg, file="fil48_ed.6.RData")
saveRDS(sen_de, file="sen48_de.6.RData")
saveRDS(sen_ed, file="sen48_ed.6.RData")
saveRDS(fdr_de, file="fdr48_de.6.RData")
saveRDS(fdr_ed, file="fdr48_ed.6.RData")