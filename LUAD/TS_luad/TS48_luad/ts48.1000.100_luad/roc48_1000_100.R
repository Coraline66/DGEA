...
fx1 <- as.numeric(readRDS("fdr_48.de.RData"))
fx2 <- as.numeric(readRDS("fdr_48.ed.RData"))
fy1 <- as.numeric(readRDS("sen_48.de.RData"))
fy2 <- as.numeric(readRDS("sen_48.ed.RData"))
...
roc.plot <- ggplot(ff, aes(fx1, fy1))  +
    ...
    theme_igray() +
    scale_color_manual(name="TS(48/1000/100)", breaks=leg, values=col) +
...
ggsave("roc.48_1000_100.luad.png", width=10, height=10)
...
ggsave(g, file="bp48_1000_100_luad.png", width=24, height=12)
