...
# Save Data
saveRDS(fil_des, file="fil48.de17.RData")
saveRDS(fil_edg, file="fil48.ed17.RData")
saveRDS(sen_de, file="sen48.de17.RData")
saveRDS(sen_ed, file="sen48.ed17.RData")
saveRDS(fdr_de, file="fdr48.de17.RData")
saveRDS(fdr_ed, file="fdr48.ed17.RData")