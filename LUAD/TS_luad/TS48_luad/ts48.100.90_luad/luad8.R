...
# Save Data
saveRDS(fil_des, file="fil48.de8.RData")
saveRDS(fil_edg, file="fil48.ed8.RData")
saveRDS(sen_de, file="sen48.de8.RData")
saveRDS(sen_ed, file="sen48.ed8.RData")
saveRDS(fdr_de, file="fdr48.de8.RData")
saveRDS(fdr_ed, file="fdr48.ed8.RData")