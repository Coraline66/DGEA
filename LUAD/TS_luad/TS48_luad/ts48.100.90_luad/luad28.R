...
en_de <- readRDS("TSde_48_100_90.RData")
en_ed <- readRDS("TSed_48_100_90.RData")
...
# Save Data
saveRDS(fil_des, file="fil48.de28.RData")
saveRDS(fil_edg, file="fil48.ed28.RData")
saveRDS(sen_de, file="sen48.de28.RData")
saveRDS(sen_ed, file="sen48.ed28.RData")
saveRDS(fdr_de, file="fdr48.de28.RData")
saveRDS(fdr_ed, file="fdr48.ed28.RData")