...
fx1 <- as.numeric(readRDS("fdr48.de.RData"))
fx2 <- as.numeric(readRDS("fdr48.ed.RData"))
fy1 <- as.numeric(readRDS("sen48.de.RData"))
fy2 <- as.numeric(readRDS("sen48.ed.RData"))
...
roc.plot <- ggplot(ff, aes(fx1, fy1))  +
    ...
    theme_igray() +
    scale_color_manual(name="TS(48/100/90)", breaks=leg, values=col) +
...
ggsave("roc.48_100_90_luad.png", width=20, height=8)
...
ggsave("roc.48_100_90.luad.png", width=10, height=10)
...
ggsave(g, file="bp48_100_90_luad.png", width=24, height=12)
