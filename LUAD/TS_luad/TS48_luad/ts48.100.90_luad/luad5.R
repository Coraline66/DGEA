...
# Save Data
saveRDS(fil_des, file="fil48.de5.RData")
saveRDS(fil_edg, file="fil48.ed5.RData")
saveRDS(sen_de, file="sen48.de5.RData")
saveRDS(sen_ed, file="sen48.ed5.RData")
saveRDS(fdr_de, file="fdr48.de5.RData")
saveRDS(fdr_ed, file="fdr48.ed5.RData")