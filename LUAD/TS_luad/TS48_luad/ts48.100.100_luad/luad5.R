...
# Save Data
saveRDS(samp, file="samp5.RData")
saveRDS(in_de, file="in_de5.RData")
saveRDS(in_ed, file="in_ed5.RData")
saveRDS(fil_des, file="fil48_de5.RData")
saveRDS(fil_edg, file="fil48_ed5.RData")
saveRDS(sen_de, file="sen48_de5.RData")
saveRDS(sen_ed, file="sen48_ed5.RData")
saveRDS(fdr_de, file="fdr48_de5.RData")
saveRDS(fdr_ed, file="fdr48_ed5.RData")