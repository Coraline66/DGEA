...
# Save Data
saveRDS(samp, file="samp45.RData")
saveRDS(in_de, file="in_de45.RData")
saveRDS(in_ed, file="in_ed45.RData")
saveRDS(fil_des, file="fil48_de45.RData")
saveRDS(fil_edg, file="fil48_ed45.RData")
saveRDS(sen_de, file="sen48_de45.RData")
saveRDS(sen_ed, file="sen48_ed45.RData")
saveRDS(fdr_de, file="fdr48_de45.RData")
saveRDS(fdr_ed, file="fdr48_ed45.RData")