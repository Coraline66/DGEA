...
saveRDS(fil_des, file="fil48_de28.RData")
saveRDS(fil_edg, file="fil48_ed28.RData")
saveRDS(sen_de, file="sen48_de28.RData")
saveRDS(sen_ed, file="sen48_ed28.RData")
saveRDS(fdr_de, file="fdr48_de28.RData")
saveRDS(fdr_ed, file="fdr48_ed28.RData")