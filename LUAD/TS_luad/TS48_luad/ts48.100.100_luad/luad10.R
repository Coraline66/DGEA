...
saveRDS(fil_des, file="fil48_de10.RData")
saveRDS(fil_edg, file="fil48_ed10.RData")
saveRDS(sen_de, file="sen48_de10.RData")
saveRDS(sen_ed, file="sen48_ed10.RData")
saveRDS(fdr_de, file="fdr48_de10.RData")
saveRDS(fdr_ed, file="fdr48_ed10.RData")