...
# Save Data
saveRDS(samp, file="samp3.RData")
saveRDS(in_de, file="in_de3.RData")
saveRDS(in_ed, file="in_ed3.RData")
saveRDS(fil_des, file="fil48_de3.RData")
saveRDS(fil_edg, file="fil48_ed3.RData")
saveRDS(sen_de, file="sen48_de3.RData")
saveRDS(sen_ed, file="sen48_ed3.RData")
saveRDS(fdr_de, file="fdr48_de3.RData")
saveRDS(fdr_ed, file="fdr48_ed3.RData")