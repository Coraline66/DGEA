...
# Save Data
saveRDS(samp, file="samp17.RData")
saveRDS(in_de, file="in_de17.RData")
saveRDS(in_ed, file="in_ed17.RData")
saveRDS(fil_des, file="fil48_de17.RData")
saveRDS(fil_edg, file="fil48_ed17.RData")
saveRDS(sen_de, file="sen48_de17.RData")
saveRDS(sen_ed, file="sen48_ed17.RData")
saveRDS(fdr_de, file="fdr48_de17.RData")
saveRDS(fdr_ed, file="fdr48_ed17.RData")