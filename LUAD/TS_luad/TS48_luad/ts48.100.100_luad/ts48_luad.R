...
# Save Data
saveRDS(samp, file="samp48.RData")
saveRDS(in_de, file="in_de48.RData")
saveRDS(in_ed, file="in_ed48.RData")
saveRDS(fil_des, file="fi_de48.RData")
saveRDS(fil_edg, file="fi_ed48.RData")
saveRDS(ts_des, file="TSde_48_100_100.RData")
saveRDS(ts_edg, file="TSed_48_100_100.RData")
saveRDS(Nde_90$int_tp, file="TSde_48_100_90.RData")
saveRDS(Ned_90$int_tp, file="TSed_48_100_90.RData")
