...
en_de <- readRDS("TSde_48_100_100.RData")
en_ed <- readRDS("TSed_48_100_100.RData")
...
# Save Data
saveRDS(samp, file="samp23.RData")
saveRDS(in_de, file="in_de23.RData")
saveRDS(in_ed, file="in_ed23.RData")
saveRDS(fil_des, file="fil48_de23.RData")
saveRDS(fil_edg, file="fil48_ed23.RData")
saveRDS(sen_de, file="sen48_de23.RData")
saveRDS(sen_ed, file="sen48_ed23.RData")
saveRDS(fdr_de, file="fdr48_de23.RData")
saveRDS(fdr_ed, file="fdr48_ed23.RData")