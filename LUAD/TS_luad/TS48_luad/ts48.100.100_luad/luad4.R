...
# Save Data
saveRDS(samp, file="samp4.RData")
saveRDS(in_de, file="in_de4.RData")
saveRDS(in_ed, file="in_ed4.RData")
saveRDS(fil_des, file="fil48_de4.RData")
saveRDS(fil_edg, file="fil48_ed4.RData")
saveRDS(sen_de, file="sen48_de4.RData")
saveRDS(sen_ed, file="sen48_ed4.RData")
saveRDS(fdr_de, file="fdr48_de4.RData")
saveRDS(fdr_ed, file="fdr48_ed4.RData")